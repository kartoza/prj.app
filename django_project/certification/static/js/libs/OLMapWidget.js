...
MapWidget.prototype.getControls = function(layer) {
    ...
    if (this.options.modifiable && this.options.geom_name.indexOf('Point') < 0) {
        this.controls.push(new OpenLayers.Control.ModifyFeature(layer, {'displayClass': 'olControlModifyFeature'}));
    } else {
        this.controls.push(new OpenLayers.Control.ModifyFeature(layer, {'displayClass': 'hiddenControlModifyFeature'}));
    }
};
