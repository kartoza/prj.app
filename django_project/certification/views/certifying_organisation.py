...
from ..models import CertifyingOrganisation
...
class CertifyingOrganisationDetailView(CertifyingOrganisationMixin,
                                       DetailView):
...
class CertifyingOrganisationDeleteView(LoginRequiredMixin,
                                       CertifyingOrganisationMixin,
                                       DeleteView):
