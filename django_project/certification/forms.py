...
class IssueAllCertificatesForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper = FormHelper()
        self.helper.html5_required = False
        super(IssueAllCertificatesForm, self).__init__(*args, **kwargs)
        self.fields['course'].initial = self.course
        self.fields['course'].widget = forms.HiddenInput()
        self.fields['attendee'].initial = self.attendee
        self.fields['attendee'].widget = forms.HiddenInput()
    ...
    def save(self, commit=True):
        instance = super(IssueAllCertificatesForm, self).save(commit=False)
        instance.author = self.user
        instance.course = self.course
        instance.attendee = self.attendee
        instance.save()
