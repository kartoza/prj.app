...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Version', fields ['slug']
        db.delete_unique(u'changes_version', ['slug'])

        # Adding unique constraint on 'Version', fields ['project', 'slug']
        db.create_unique(u'changes_version', ['project_id', 'slug'])

        # Adding unique constraint on 'Category', fields ['project', 'slug']
        db.create_unique(u'changes_category', ['project_id', 'slug'])

        # Adding unique constraint on 'Entry', fields ['version', 'slug']
        db.create_unique(u'changes_entry', ['version_id', 'slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Entry', fields ['version', 'slug']
        db.delete_unique(u'changes_entry', ['version_id', 'slug'])

        # Removing unique constraint on 'Category', fields ['project', 'slug']
        db.delete_unique(u'changes_category', ['project_id', 'slug'])

        # Removing unique constraint on 'Version', fields ['project', 'slug']
        db.delete_unique(u'changes_version', ['project_id', 'slug'])

        # Adding unique constraint on 'Version', fields ['slug']
