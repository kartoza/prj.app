...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Category.sort_number'
        db.add_column(u'changes_category', 'sort_number',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.sort_number'
        db.delete_column(u'changes_category', 'sort_number')
