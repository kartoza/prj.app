...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='sponsor',
            name='sponsorshipperiod',
            field=models.ForeignKey(help_text=b'The period of your sponsorship', to='changes.SponsorshipPeriod'),
        ),
        migrations.AddField(
            model_name='entry',
            name='version',
        ...
        migrations.AlterUniqueTogether(
            name='sponsorshipperiod',
            unique_together=set([('project', 'slug'), ('sponsorshiplevel', 'project')]),
        ),
        migrations.AlterUniqueTogether(
            name='sponsorshiplevel',
