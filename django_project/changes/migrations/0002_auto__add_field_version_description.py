...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Version.description'
        db.add_column(u'changes_version', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Version.description'
        db.delete_column(u'changes_version', 'description')
