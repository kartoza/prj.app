...
class Project(models.Model):
    ...
    image_file = models.ImageField(
        help_text=_(
            'A logo image for this project. Most browsers support '
            'dragging the image directly on to the "Choose File" '
            'button above. The ideal size for your image is 512 x 512 pixels.'),
