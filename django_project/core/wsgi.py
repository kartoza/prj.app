"""
WSGI config for visual_changelogger project.
...
# os.environ["DJANGO_SETTINGS_MODULE"] = "visual_changelogger.settings"
os.environ.setdefault("DJANGO_SETTINGS_MODULE", "core.settings.dev_george")
