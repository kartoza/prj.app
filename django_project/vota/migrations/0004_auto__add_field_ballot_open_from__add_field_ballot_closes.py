...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ballot.open_from'
        db.add_column(u'vota_ballot', 'open_from',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 12, 13, 0, 0)),
                      keep_default=False)

        # Adding field 'Ballot.closes'
        db.add_column(u'vota_ballot', 'closes',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 12, 13, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ballot.open_from'
        db.delete_column(u'vota_ballot', 'open_from')

        # Deleting field 'Ballot.closes'
        db.delete_column(u'vota_ballot', 'closes')
    ...
    models = {
        ...
        'vota.ballot': {
            ...
            'approved': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'closes': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 13, 0, 0)'}),
            ...
            'open_from': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 13, 0, 0)'})
        },
        'vota.committee': {
            ...
            'quorum_setting': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
