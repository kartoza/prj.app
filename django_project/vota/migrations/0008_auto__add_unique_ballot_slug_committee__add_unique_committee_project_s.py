...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Ballot', fields ['slug', 'committee']
        db.create_unique(u'vota_ballot', ['slug', 'committee_id'])

        # Adding unique constraint on 'Committee', fields ['project', 'slug']
        db.create_unique(u'vota_committee', ['project_id', 'slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Committee', fields ['project', 'slug']
        db.delete_unique(u'vota_committee', ['project_id', 'slug'])

        # Removing unique constraint on 'Ballot', fields ['slug', 'committee']
        db.delete_unique(u'vota_ballot', ['slug', 'committee_id'])
