...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Committee.chair'
        db.add_column(u'vota_committee', 'chair',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='committee_chairman', to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Committee.chair'
        db.delete_column(u'vota_committee', 'chair_id')
    ...
    models = {
        ...
        'vota.committee': {
            ...
            'chair': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'committee_chairman'", 'to': u"orm['auth.User']"}),
