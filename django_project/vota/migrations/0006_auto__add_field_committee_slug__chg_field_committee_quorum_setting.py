...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'vota_committee', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default=u'test-committee', max_length=50),
                      keep_default=False)


        # Changing field 'Committee.quorum_setting'
        db.delete_column(u'vota_committee', 'quorum_setting')
	db.add_column(u'vota_committee', 'quorum_setting', self.gf('django.db.models.fields.CharField')(default=u'100', max_length=3))

    def backwards(self, orm):
        # Deleting field 'Committee.slug'
        db.delete_column(u'vota_committee', 'slug')


        # Changing field 'Committee.quorum_setting'
        db.alter_column(u'vota_committee', 'quorum_setting', self.gf('django.db.models.fields.CharField')(max_length=20))
    ...
    models = {
        ...
        'vota.ballot': {
            ...
            'approved': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'closes': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 16, 0, 0)'}),
