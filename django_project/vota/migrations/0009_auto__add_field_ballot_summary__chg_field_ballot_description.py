...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ballot.summary'
        db.add_column(u'vota_ballot', 'summary',
                      self.gf('django.db.models.fields.CharField')(default=u'This is a brief summary of the test ballot. A description should be used if more detail is required', max_length=250),
                      keep_default=False)
