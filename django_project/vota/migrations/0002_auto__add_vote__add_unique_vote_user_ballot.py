...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'vota_vote', (
            ...
            ('creator', self.gf('threaded_multihost.fields.CreatorField')(default=None, related_name='vote_created', null=True, blank=True, to=orm['auth.User'])),
            ('editor', self.gf('threaded_multihost.fields.EditorField')(blank=True, related_name='vote_last_modified', null=True, to=orm['auth.User'])),
            ('positive', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('abstain', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('negative', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('ballot', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['vota.Ballot'])),
        ))
        db.send_create_signal('vota', ['Vote'])

        # Adding unique constraint on 'Vote', fields ['user', 'ballot']
        db.create_unique(u'vota_vote', ['user_id', 'ballot_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Vote', fields ['user', 'ballot']
        db.delete_unique(u'vota_vote', ['user_id', 'ballot_id'])

        # Deleting model 'Vote'
        db.delete_table(u'vota_vote')
