...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ballot.slug'
        db.add_column(u'vota_ballot', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default=u'test-ballot', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ballot.slug'
        db.delete_column(u'vota_ballot', 'slug')
