...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Vote.abstain'
        db.delete_column(u'vota_vote', 'abstain')

        # Deleting field 'Vote.positive'
        db.delete_column(u'vota_vote', 'positive')

        # Deleting field 'Vote.negative'
        db.delete_column(u'vota_vote', 'negative')

        # Adding field 'Vote.choice'
        db.add_column(u'vota_vote', 'choice',
                      self.gf('django.db.models.fields.CharField')(default='-', max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Vote.abstain'
        db.add_column(u'vota_vote', 'abstain',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Vote.positive'
        db.add_column(u'vota_vote', 'positive',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Vote.negative'
        db.add_column(u'vota_vote', 'negative',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Vote.choice'
        db.delete_column(u'vota_vote', 'choice')
    ...
    models = {
        ...
        'vota.ballot': {
            ...
            'approved': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'closes': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 15, 0, 0)'}),
            ...
            'open_from': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 8, 0, 0)'}),
            'private': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
